...
set.seed(22)
wordcloud(interests_words, interests_sizes, min.freq=1, random.order = FALSE, max.words = Inf, scale=c(1.5,0.2), colors = interests_colours, ordered.colors = TRUE, rot.per=.15)
